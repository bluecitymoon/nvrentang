    	   ...
    	   <div class="row">
                ...
                <div class="icon upright">  
        		 <a href="${customerUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_marcofolio.png" />" alt="客户" /></a>
                  <p class="ico_txt">录入</p>
                </div>
                
    	   </div>
    	    <div class="row">
    	         <div class="icon upleft">  
        		 <a href="${productUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_settings.png" />" alt="产品" /></a>
                  <p class="ico_txt">客户</p>
                </div>
                <div class="icon upright">  
        		 <a href="${productUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_itunes.png" />" alt="产品" /></a>
                  <p class="ico_txt">售后服务</p>
                </div>
                <div class="icon upright">  
        		 <a href="${productUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_mail.png" />" alt="产品" /></a>
                  <p class="ico_txt">报表</p>
                </div>
    	   </div>
    	   
    	   <div class="row">
    	         <div class="icon upleft">  
        		 <a href="${notesUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_appstore.png" />" alt="产品" /></a>
                  <p class="ico_txt">进账</p>
                </div>
                <div class="icon upright">  
        		 <a href="${productUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_camera.png" />" alt="产品" /></a>
                  <p class="ico_txt">出账</p>
                </div>
                <div class="icon upright">  
        		 <a href="${productUrl}" title="Text" class="ico_btn"><img src="<c:url value="/img/icon_clock.png" />" alt="产品" /></a>
                  <p class="ico_txt">总账</p>
                </div>
    	   </div>
      </div>
   </div>
